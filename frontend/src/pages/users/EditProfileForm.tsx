...
const EditProfileForm = () => {
  ...
  return (
    <Form method="patch">
      <div className="mt-5">
        <label htmlFor="tavernEditProfileUsername" className="sr-only">
          Username
        </label>
        <input
          id="tavernEditProfileUsername"
          type="text"
      ...
      <div className="mt-5">
        <label htmlFor="tavernEditProfileEmail" className="sr-only">
          Email
        </label>
        <input
          id="tavernEditProfileEmail"
          type="text"
          placeholder="Email"
          value={state.email}
          onChange={(e) =>
      ...
      <div className="mt-5">
        <label htmlFor="tavernEditProfileNickname" className="sr-only">
          Nickname
        </label>
        <input
          id="tavernEditProfileNickname"
          type="text"
      ...
      <div className="mb-1">
        <label htmlFor="tavernEditProfileGender" className="sr-only">
          Gender
        </label>
        <select
          id="tavernEditProfileGender"
          name="gender"
      ...
      <div className="mb-1">
        <label htmlFor="tavernEditProfileHeroClass" className="sr-only">
          Hero Class
        </label>
        <input
          id="tavernEditProfileHeroClass"
          type="text"
